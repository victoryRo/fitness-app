...
values ($1, $2) RETURNING set_id, exercise_id, weight
`
...
values ($1, $2, $3) RETURNING image_id, user_id, content_type, image_data
`
...
VALUES ($1, $2, $3) RETURNING user_id, user_name, pass_word_hash, name, config, created_at, is_enabled
`
