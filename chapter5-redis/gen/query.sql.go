...
func (q *Queries) CreateSet(ctx context.Context, arg CreateSetParams) (AppSet, error) {
...
func (q *Queries) CreateWorkout(ctx context.Context, arg CreateWorkoutParams) (AppWorkout, error) {
...
func (q *Queries) ListExercises(ctx context.Context) ([]AppExercise, error) {
	rows, err := q.db.QueryContext(ctx, listExercises)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []AppExercise
	for rows.Next() {
		var i AppExercise
...
func (q *Queries) ListSets(ctx context.Context) ([]AppSet, error) {
...
func (q *Queries) ListWorkouts(ctx context.Context) ([]AppWorkout, error) {
	rows, err := q.db.QueryContext(ctx, listWorkouts)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []AppWorkout
	for rows.Next() {
		var i AppWorkout
		if err := rows.Scan(
			&i.WorkoutID,
